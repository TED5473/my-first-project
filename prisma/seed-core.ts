...
const BRANDS: SeedBrand[] = [
  ...
  // ─────────────────────────────────────────────────────────────────────────
  // Lynk & Co — Geely-group PHEV/BEV; three nameplates in IL (01, 02, 08).
  // Cartube 2026 prices:
  //   01 Pro PHEV 179,900  / 01 Halo PHEV 198,900
  //   02 Pro BEV  171,900  / 02 Halo BEV 179,900
  //   08 Pro PHEV 229,900  / 08 Halo PHEV 249,900
  // Dimensions: 01 4,545 mm · 02 4,460 mm · 08 4,825 mm (cartube spec pages).
  // ─────────────────────────────────────────────────────────────────────────
  {
    name: "Lynk & Co",
    slug: "lynk-co",
    ...
    models: [
      {
        ...
        bodyStyle: "SUV",
        brandMix: 0.45,
        notes: "C-SUV PHEV, 1.5T + 17.7 kWh NMC, 75 km e-range.",
        trims: [
          {
            name: "Pro PHEV",
            powertrain: "PHEV",
            ...
            eRangeKm: 75,
            power: 206,
            priceListIls: 112_000,
            onRoadPriceIls: 179_900,
            importerUrl: "https://lynkco.co.il",
            mix: 0.6,
          },
          {
            name: "Halo PHEV",
      ...
      },
      {
        ...
        bodyStyle: "Crossover",
        brandMix: 0.40,
        notes: "BEV crossover, shares SEA platform with Smart #1 and Zeekr X.",
        trims: [
          {
            name: "Pro BEV",
            powertrain: "BEV",
            ...
            power: 200,
            fwdAwd: "RWD",
            priceListIls: 144_000,
            onRoadPriceIls: 171_900,
            mix: 0.6,
          },
          {
            name: "Halo BEV",
      ...
      // 4th model: Z10 flagship BEV sedan — arriving in IL through Meir.
      // Based on Zeekr 001 (5,028 mm), 95 kWh LFP, 272-778 hp range.
      {
        name: "Z10",
        slug: "z10",
        segment: "E",
        bodyStyle: "Sedan",
        brandMix: 0.03,
        notes: "First full-BEV for Lynk & Co in IL — 001-based premium sedan.",
        trims: [
          {
            name: "Long Range RWD",
            powertrain: "BEV",
            ...
            power: 200,
            fwdAwd: "RWD",
            priceListIls: 220_000,
            onRoadPriceIls: 264_900,
            mix: 0.65,
          },
          {
            ...
            power: 580,
            fwdAwd: "AWD",
            priceListIls: 240_000,
            onRoadPriceIls: 294_900,
            mix: 0.35,
          },
        ],
      },
  ...
  // ─────────────────────────────────────────────────────────────────────────
  // Zeekr — Geely premium-BEV sub-brand; three nameplates in IL (X, 7X, 001).
  // Cartube 2026 prices:
  //   X Long Range RWD 184,990 · X Beyond RWD 186,990 · X Krypton AWD 209,990
  //   7X Essence RWD 233,990 · 7X Long Range RWD 262,990 · 7X Krypton AWD 289,990
  //   001 Long Range RWD 283,990 · 001 Performance AWD 309,990 · 001 Krypton 344,990
  // ─────────────────────────────────────────────────────────────────────────
  {
    name: "Zeekr",
    slug: "zeekr",
    ...
    models: [
      {
        ...
        bodyStyle: "SUV",
        brandMix: 0.55,
        notes: "Premium compact BEV SUV on Geely SEA, sibling of Smart #1 and Volvo EX30.",
        trims: [
          {
            name: "RWD Long Range",
            powertrain: "BEV",
            ...
            priceListIls: 155_000,
            onRoadPriceIls: 184_990,
            importerUrl: "https://www.zeekr.co.il",
            mix: 0.50,
          },
          {
            name: "RWD Beyond",
        ...
        trims: [
          {
            ...
            power: 310,
            fwdAwd: "RWD",
            priceListIls: 196_000,
            onRoadPriceIls: 233_990,
            mix: 0.45,
          },
          {
            name: "RWD Long Range",
      ...
      },
      {
        ...
        bodyStyle: "Sedan",
        brandMix: 0.12,
        notes: "Shooting-brake premium EV, competes with BMW i5.",
        trims: [
          {
            name: "RWD Long Range",
            powertrain: "BEV",
            ...
            power: 200,
            fwdAwd: "RWD",
            priceListIls: 238_000,
            onRoadPriceIls: 283_990,
            mix: 0.45,
          },
          {
            ...
            power: 400,
            fwdAwd: "AWD",
            priceListIls: 260_000,
            onRoadPriceIls: 309_990,
            mix: 0.35,
          },
          {
            name: "AWD Krypton",
            ...
            power: 400,
            fwdAwd: "AWD",
            priceListIls: 289_000,
            onRoadPriceIls: 344_990,
            mix: 0.20,
          },
        ],
      },
      // 4th model: 009 — full-size premium BEV MPV.
      // Cartube: 5,209 mm, 140 kWh pack, 822 km CLTC (≈ 700 km WLTP), 6 seats.
      {
        name: "009",
        slug: "009",
        segment: "E-MPV",
        bodyStyle: "MPV",
        brandMix: 0.03,
        notes: "Premium 6-seat BEV minivan — fleet/VIP play, competes with Volvo EM90.",
        trims: [
          {
            name: "Long Range AWD",
            powertrain: "BEV",
            ...
            power: 400,
            fwdAwd: "AWD",
            priceListIls: 320_000,
            onRoadPriceIls: 389_900,
            mix: 0.6,
          },
          {
            name: "Grand AWD",
            ...
            power: 580,
            fwdAwd: "AWD",
            priceListIls: 360_000,
            onRoadPriceIls: 439_900,
            mix: 0.4,
          },
        ],
      },
